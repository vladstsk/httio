...
export default function client(options?: HttioClientOptions): HttioClient {
  ...
  return {
    delete(path: string, options?: HttioMethodOptions): HttioResponse {
      ...
      return open(url(base, path, query), { ...$options, method: "DELETE" });
    },
